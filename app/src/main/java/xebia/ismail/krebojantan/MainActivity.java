...
import xebia.ismail.krebojantan.fragment.FragmentHome;
    ...
    private void navigate(final int itemId) {
        ...
        switch (itemId) {
            case R.id.nav_1:
                ...
                navFragment = new FragmentHome();
                break;
            case R.id.nav_2:
                startActivity(new Intent(this, AllMenu.class));
                mNavigationView.getMenu().findItem(mPrevSelectedId).setChecked(true);
                return;
            case R.id.nav_3:
                //mPrevSelectedId = itemId;
                setTitle(R.string.nav_bank);
                navFragment = new NearestBankFragment();
                break;
            case R.id.nav_4:
                mPrevSelectedId = itemId;
                //setTitle(R.string.nav_tips);
                navFragment = new TipsFragment();
                break;
            case R.id.nav_6:
